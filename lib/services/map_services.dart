...
class MapServices {
  final String key = 'AIzaSyBZuvRFoDOZW3WPzdCyQN-sGIDPEGkRx3c';
  ...
  Future<dynamic> getLayerDetails(String token) async {
    final String url =
        'https://maps.googleapis.com/maps/api/place/details/json?query=restaurants&key=$key';
